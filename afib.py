...
folder_paths = [
    '/home/hice1/yfarooq3/Deep-Learning-Models-for-AF-Detection-from-ECG-Signals/Data/Class_A',
    '/home/hice1/yfarooq3/Deep-Learning-Models-for-AF-Detection-from-ECG-Signals/Data/Class_A'  #Removed Folder O Since we want binary classification
]
...
train, test = train_test_split(dataFrame, test_size=0.2, random_state=43, stratify=dataFrame['label'])
...
torch.save(model.state_dict(), 'afib_specialist.pt')
print("Saved AFib specialist weights to afib_specialist.pt")
